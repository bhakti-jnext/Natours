...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmhha3RpMTIzIiwiYSI6ImNrc2lzcHNvNjFwdGEycG51eDQ0ZHg0aDIifQ.G8o7xUbkX4fwhD1afbWw7g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/bhakti123/cksivhx7hd6tv17pe87mdtd7j',
    scrollZoom: false // center: [-118.315192, 34.006905],
    // zoom: 1,
    // interactive: false,
...
var stripe = Stripe('pk_test_51JRbEXSJhoHB9vBKbAXJGfWYK2APvr1hgZq8zgGTXIECRtPVIo5Q98CQqO2vwKD4D0eNxlNCthjrk8hpMtFtOpmu004FRNWHP5');
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              document.querySelector('.btn--save__password').value = 'Updating....';
            ...
            case 7:
              document.querySelector('.btn--save__password').value = 'Save Password';
